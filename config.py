...
class BaseConfiguration(object):
    ...
    # default ticket_system_admin group name
    ADMIN_GROUP_NAME = 'ticket_system_admin'
    ...
    WEBHOME = '/'
    # The base url for ticket_system.
    FLICKET = WEBHOME + ''
    FLICKET_API = WEBHOME + 'ticket_system-api/'
    FLICKET_REST_API = WEBHOME + 'ticket_system-rest-api'
    ADMINHOME = '/ticket_system_admin/'

    # ticket_system user used to post replies to tickets for status changes.
