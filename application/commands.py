...
from application.ticket_system.models.ticket_system_models import FlicketCategory
from application.ticket_system.models.ticket_system_models import FlicketDepartment
from application.ticket_system.models.ticket_system_models import FlicketPriority
from application.ticket_system.models.ticket_system_models import FlicketStatus
from application.ticket_system.models.ticket_system_models import FlicketTicket
from application.ticket_system.models.ticket_system_user import FlicketGroup
...
from application.ticket_system.scripts.ticket_system_details import FlicketUserDetails
from application.ticket_system.scripts.hash_password import hash_password

admin = 'admin'

# configuration defaults for ticket_system
flicket_config = {'posts_per_page': 50,
                  'allowed_extensions': ['txt', 'log', 'pdf', 'png', 'jpg', 'jpeg', 'gif', 'msg', 'doc', 'docx', 'ppt',
                                         'pptx', 'xls', 'xlsx'],
                  'ticket_upload_folder': 'application/ticket_system/static/ticket_system_uploads',
                  'avatar_upload_folder': 'application/ticket_system/static/ticket_system_avatars',
                  }

# departments and categories defaults for ticket_system
depart_categories = [
...
def create_admin(username, password, email, job_title, silent=False):
    """ creates ticket_system_admin user. """
...
def create_admin_group(silent=False):
    """ creates ticket_system_admin and super_user group and assigns ticket_system_admin to group admin. """
    ...
    in_group = False
    # see if user ticket_system_admin is already in ticket_system_admin group.
    ...
    if not in_group:
        ...
        if not silent:
            print("Added ticket_system_admin user to ticket_system_admin group.")
