...
"""
    ...
    .. http:get:: /ticket_system-api/department/(int:department_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/department/1 HTTP/1.1
            HOST: localhost:5000
    ...
    .. http:get:: /ticket_system-api/departments/

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/departments/ HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
    ...
    .. http:post:: http://localhost:5000/flicket-api/departments(str:department)
        ...
        **Request**
        ...
        .. sourcecode:: http
            ...
            POST /ticket_system-api/departments HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
