...
"""
    ...
    .. http:get:: /ticket_system-api/post/(int:post_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/priority/1 HTTP/1.1
            HOST: localhost:5000
    ...
    .. http:get:: /ticket_system-api/posts/(int:ticket_id)/(int:page)/

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/posts/1/ HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
