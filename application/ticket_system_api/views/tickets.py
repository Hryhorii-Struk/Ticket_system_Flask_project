...
"""
    ...
    .. http:get:: /ticket_system-api/ticket/(int:ticket_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/ticket/1 HTTP/1.1
            HOST: localhost:5000
    ...
    ~~~~~~~~~~~
        ...
        .. http:get:: /ticket_system-api/tickets/

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/tickets/ HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
    ...
    .. http:post:: /ticket_system-api/tickets(str:title,str:content,int:category_id,int:ticket_priority_id)

        **Request**

        .. sourcecode:: http

            POST /ticket_system-api/tickets HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
...
from application.ticket_system.models.ticket_system_models import FlicketPriority, FlicketTicket, FlicketCategory
from application.ticket_system_api.views.auth import token_auth
from application.ticket_system_api.views.errors import bad_request
