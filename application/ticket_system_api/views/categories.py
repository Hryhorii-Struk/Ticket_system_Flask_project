...
"""
    ...
    .. http:get:: /ticket_system-api/category/(int:category_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/category/1 HTTP/1.1
            HOST: localhost:5000
    ...
    .. http:get:: /ticket_system-api/categories/

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/categories/ HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
...
from application.ticket_system.models.ticket_system_models import FlicketCategory, FlicketDepartment
