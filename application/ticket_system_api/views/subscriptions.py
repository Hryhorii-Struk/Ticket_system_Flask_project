...
"""
    ...
    .. http:get:: /ticket_system-api/subscription/(int:subscription_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/subscription/1 HTTP/1.1
            HOST: localhost:5000
    ...
    .. http:get:: /ticket_system-api/subscriptions/(int:ticket_id)/
