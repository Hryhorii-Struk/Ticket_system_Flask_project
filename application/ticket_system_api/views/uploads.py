...
"""
    ...
    .. http:get:: /ticket_system-api/upload/(int:upload_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/upload/1 HTTP/1.1
            HOST: localhost:5000
    ...
    .. http:get:: /ticket_system-api/uploads/

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/uploads/ HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
