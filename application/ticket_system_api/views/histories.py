...
"""
    ...
    .. http:get:: /ticket_system-api/history/(int:history_id)

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/history/1 HTTP/1.1
            HOST: localhost:5000
    ...
    .. http:get:: /ticket_system-api/histories/

        **Request**

        .. sourcecode:: http

            GET /ticket_system-api/histories/ HTTP/1.1
            HOST: localhost:5000
            Accept: application/json
            Authorization: Bearer <token>
