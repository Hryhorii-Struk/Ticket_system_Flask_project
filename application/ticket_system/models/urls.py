...
models_blueprint.add_url_rule('/urls.py/', view_func=views.UserListView.as_view('user_list'))
models_blueprint.add_url_rule('/urls.py/<int:user_id>/', view_func=views.UserDetailView.as_view('user_detail'))