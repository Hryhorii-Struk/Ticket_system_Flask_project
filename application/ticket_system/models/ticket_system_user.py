...
class FlicketUser(PaginatedAPIMixin, UserMixin, Base):
    ...
    def is_admin(self):
        ...
        Returns true if the user is a member of the 'ticket_system_admin' group.
    ...
    def to_dict(self):
        ...
        avatar_url = app.config['base_url'] + url_for('flicket_bp.static',
                                                      filename='ticket_system_avatars/{}'.format("__default_profile.png"))

        if self.avatar:
            avatar_url = app.config['base_url'] + url_for('flicket_bp.static',
                                                          filename='ticket_system_avatars/{}'.format(self.avatar))
...
class FlicketGroup(Base):
    ...
    # ie everyone in group 'ticket_system_admin' can be a member of group 'all'
