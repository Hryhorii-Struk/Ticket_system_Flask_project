...
from wtforms import HiddenField, SubmitField, FileField, DecimalField
...
from application.ticket_system.models.ticket_system_models import field_size
from application.ticket_system.models.ticket_system_user import FlicketUser, user_field_size
from application.ticket_system.scripts.upload_choice_generator import generate_choices
...
class TicketForm(FlaskForm):
    ...
    status = SelectField('Status', choices=['Pending', 'In review', 'Closed'])
