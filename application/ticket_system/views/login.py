...
from application.ticket_system.forms.form_login import LogInForm
from application.ticket_system.forms.form_login import PasswordResetForm
...
from application.ticket_system.scripts.ticket_system_config import set_flicket_config
...
def login():
    ...
    return render_template('ticket_system_login.html', title='Log In', form=form)
...
def password_reset():
    ...
    return render_template('ticket_system_password_reset.html', form=form, title=title)
