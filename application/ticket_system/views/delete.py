...
from application.ticket_system.forms.forms_main import ConfirmPassword
...
def delete_ticket(ticket_id):
    ...
    return render_template('ticket_system_deletetopic.html',
                           form=form,
                           ticket=ticket,
                           title='Delete Ticket')
...
def delete_post(post_id):
    ...
    return render_template('ticket_system_deletepost.html',
                           form=form,
                           post=post,
                           title=title)
...
def delete_category(category_id=False):
    if category_id:
        ...
        return render_template('ticket_system_delete.html',
                               form=form,
