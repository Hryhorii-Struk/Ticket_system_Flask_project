...
from application.ticket_system.forms.ticket_system_forms import DepartmentForm
...
def departments(page=1):
    ...
    return render_template('ticket_system_departments.html',
                           title=title,
                           form=form,
                           page=page,
...
def department_edit(department_id=False):
    if department_id:
        ...
        return render_template('ticket_system_department_edit.html',
