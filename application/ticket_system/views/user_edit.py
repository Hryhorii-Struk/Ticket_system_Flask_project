...
from application.ticket_system.forms.forms_main import EditUserForm
from application.ticket_system.models.ticket_system_user import FlicketUser
from application.ticket_system.scripts.ticket_systemupload import UploadAvatar
from application.ticket_system.scripts.functions_login import check_password_format, password_requirements
...
def user_details():
    ...
    return render_template('ticket_system_edituser.html', form=form, title='Edit User Details')
