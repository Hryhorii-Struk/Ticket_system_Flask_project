...
from application.ticket_system.forms.ticket_system_forms import ReplyForm, SubscribeUser
...
from application.ticket_system.models.ticket_system_models import FlicketPost
...
from application.ticket_system.scripts.ticket_system_functions import block_quoter
...
from application.ticket_system.scripts.subscriptions import subscribe_user
...
def ticket_view(ticket_id, page=1):
    ...
    return render_template('ticket_system_view.html',
                           title=title,
                           ticket=ticket,
                           form=form,
