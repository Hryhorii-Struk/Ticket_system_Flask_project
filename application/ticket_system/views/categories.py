...
from application.ticket_system.forms.ticket_system_forms import CategoryForm
...
def categories(department_id=False):
    ...
    return render_template('ticket_system_categories.html',
                           title=title,
                           form=form,
...
def category_edit(category_id=False):
    if category_id:
        ...
        return render_template('ticket_system_category_edit.html',
                               title=title,
                               form=form,
                               category=category,
