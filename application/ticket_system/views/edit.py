...
from application.ticket_system.forms.ticket_system_forms import EditTicketForm, EditReplyForm
from application.ticket_system.models.ticket_system_models import FlicketHistory
...
def edit_ticket(ticket_id):
    ...
    return render_template('ticket_system_edittopic.html',
                           title=title,
                           form=form)
...
def edit_post(post_id):
    ...
    return render_template('ticket_system_editpost.html',
                           title='Edit Post',
                           form=form)
