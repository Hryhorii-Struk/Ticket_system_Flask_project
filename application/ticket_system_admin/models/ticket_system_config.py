...
class FlicketConfig(Base):
    """
    Server configuration settings editable by administrators only via the administration page `/ticket_system_admin/config/`.
    ...
    :param str mail_username: example: `ticket_system.admin`
    :param str mail_password:
    :param str mail_default_sender: example: `ticket_system.admin@yourcompany.com`
