...
from application.ticket_system.scripts.functions_login import check_email_format
...
from application.ticket_system.models.ticket_system_user import user_field_size
...
class AddGroupForm(FlaskForm):
    """ Add group form for ticket_system_admin section. """
